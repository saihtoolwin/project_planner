      ...
      <div class="flex justify-between">
        ...
        <div class="space-x-3">
          <span
            ...
            class="material-symbols-outlined text-green-500 cursor-pointer hover:text-green-700"
          ...
          <span
            ...
            class="material-symbols-outlined text-red-500 cursor-pointer hover:text-red-700"
            @click="completeProject(project.id)"
          >
            close
          </span>
          <router-link :to="{ name: 'EditProject' ,params:{id:project.id}}">
            <span
              class="material-symbols-outlined text-blue-500 cursor-pointer hover:text-blue-700"
            >
              edit_square
            </span>
          </router-link>
